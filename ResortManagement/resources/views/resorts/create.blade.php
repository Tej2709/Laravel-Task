        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Create New Resort</h4>
                </div>
                <div class="card-body">

                    <form action="{{ route('resorts.store') }}" method="POST" enctype="multipart/form-data" id="resortcreateform">
                        @csrf
                        @method('POST')

                        <div class="form-group">
                            <label for="Name">Resort Name</label>
                            <input type="text" class="form-control" id="name" placeholder="Please enter resort name" name="name" value="{{old('name')}}">
                        </div>
                        @if ($errors->has('name'))
                        ...
                        <div class="form-group mb-3">
                            ...
                            <a href="{{ route('resorts.index') }}" class="btn btn-danger float-end">BACK</a>
                        </div>
